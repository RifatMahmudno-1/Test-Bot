module.exports = function (msg, ytdl, voiceChannel, Int, Int1, maindb, guildID, bossfn, tokens, helperr) {
    ...
    maindb.findById(guildID)
        .then(hs => {
            if (hs === null) {
                ...
                bossfn.setVid(num, msg, ytdl, voiceChannel, Int, Int1, maindb, guildID)
            } else {
